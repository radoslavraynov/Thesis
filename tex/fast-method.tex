...
o22 = false
\end{verbatim}
The two matrices corresponding the selected (distinct) sets of columns are nonsingular.
\begin{verbatim}
i23 : M1=sub(M1,T);
...
Since we are on a $\PP^1$, we should use this and work over 2 variables only.
\begin{verbatim}
i32 : time D1=det(M1');
...
o34 : List
\end{verbatim}
The degree of the common intersection is $48$! We are done.
\end{example}
