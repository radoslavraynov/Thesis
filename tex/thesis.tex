...
The implicitization problem asks for techniques for computing the implicit equation.

This is an old problem in algebraic geometry, and can be solved effectively
through elimination using Gr\"obner bases.
However, this solution represents a black box in terms of the geometry on $X$ and $Y$,
...
the $\gcd$ of whose maximal minors give a power of the implicit equation.

Unlike other methods, our approach is immune to base points and works well if
various assumptions as relaxed.
Furthermore, its ideas 

We design and implement a fast algorithm for computation in previously intractable situations.
\end{abstract}
